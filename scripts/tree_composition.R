...
parcs<-prop.table(as.matrix(com_par), margin = 1)
viari<-prop.table(as.matrix(com_via), margin = 1)
zona<-prop.table(as.matrix(com_zon), margin = 1)
total<-prop.table(as.matrix(com), margin = 1)
...
bcn2 <- subset(bcn2, select=c(log(RDLpc_2019), densitat, vida_esp, edat))
...
pal1 <- colorRampPalette(c("green", "blue"))(ncol(x))
pal2 <- colorRampPalette(c("green", "red3"))(nrow(x))
pal3 <- colorRampPalette(c("blue", "yellow"))(nrow(x))
...
pal1 <- colorRampPalette(c("green", "blue"))(num)
pal2 <- colorRampPalette(c("green", "red3"))(num)
pal3 <- colorRampPalette(c("blue", "yellow"))(num)
